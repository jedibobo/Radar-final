...
precisions={"FP32":fluid.core.AnalysisConfig.Precision.Float32,
...
class Predictor:
    def __init__(self,
                 ...
                 use_static=False,
                 use_dynamic_input=False,
                 precision_mode=precisions["FP32"],
        ...
        self.use_dynamic_input=use_dynamic_input
    ...
    def create_predictor(self,
        ...
        if use_gpu:
            ...
            if use_trt:
                print(precisions[self.precision_mode])
                config.enable_tensorrt_engine(
                            workspace_size=1<<10,
                            max_batch_size=max_trt_batch_size,
                            min_subgraph_size=3,
                            precision_mode=precisions[self.precision_mode],
                            use_static=self.use_static,
                            use_calib_mode=self.use_calib_mode)
                if self.use_dynamic_input:
